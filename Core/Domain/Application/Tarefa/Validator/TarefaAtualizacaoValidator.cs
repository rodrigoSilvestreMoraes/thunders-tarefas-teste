...
{
	public class TarefaAtualizacaoValidator  : AbstractValidator<TarefaAlteracao>
	{
		public TarefaAtualizacaoValidator()
		{
			RuleFor(x => x.Id).NotNull().NotEmpty().WithMessage(MensagensPadroes.CampoObrigatorio("Id"));
